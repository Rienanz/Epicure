			...
			<?php
				...
				?>				
					...
					<select id='txtTipoEndereco' name='txtTipoEndereco'>
						...
						<option value='Prédio' selected="<?php if($tipoEmpresa == "Predio"){echo("selected");} ?>"?>>Prédio</option>
						<option value='Galpão' selected="<?php if($tipoEmpresa == "Galpao"){echo("selected");} ?>">Galpão</option>
